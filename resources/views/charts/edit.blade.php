            ...
            <form x-data="{
                ...
                <div class="mt-4" x-data="{ showTimeInfo: @js(\App\Enums\ScaleType::Time->value === ($chart->config['scaleType'] ?? null)) }">
                    ...
                    <p x-show="showTimeInfo" x-cloak class="mt-2 text-sm">Category column for
                        date/time charts should be in <a
                            href="https://en.wikipedia.org/wiki/ISO_8601"
                            class="underline hover:no-underline"><strong>ISO 8601 format</strong>
                        </a>. Some components can be omited e.g <strong>YYYY, YYYY-MM, or
                            YYYY-MM-DD</strong>
                    </p>
        ...
        <div class="mb-12">
            ...
            @if (($chart->config['scaleType'] ?? null) === \App\Enums\ScaleType::Time->value)
                <div
                    ...
                    <form method="POST"
                        action="{{ route('charts.sort', ['chart' => $chart]) }}">
                        @csrf
                        @method('PUT')
