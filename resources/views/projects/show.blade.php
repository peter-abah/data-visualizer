    ...
    <header class="pb-4 mb-6 border-b">
        <div class="flex items-center">
            ...
            <div class="ml-auto flex gap-4 justify-end">
                <a href="#" class=" px-4 py-2 rounded-md text-sm font-medium border hover:bg-slate-50">
                    Create chart
                </a>
                ...
                <a href="#" class="px-4 py-2 rounded-md text-sm shadow-sm font-bold bg-red-500 text-white hover:bg-red-700">
                    Delete Project
                </a>
            </div>
        </div>
