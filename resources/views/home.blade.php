<x-layout>
    <div class="bg-white text-black">
        <header class="sticky top-0 flex items-center justify-between bg-white shadow-sm px-8 py-4">
            ...
            <nav>
                <ul>
                    <li><a class="flex items-center gap-2 rounded-md border border-neutral-300 px-6 py-2 font-bold hover:bg-black hover:text-white"
                            href={{ route('register') }}>Get Started <x-icons.arrow-forward
                                class="w-5 fill-current" /></a></li>
                </ul>
            </nav>
        </header>
        ...
        <section class="grid place-items-center p-24 text-center">
            <h2 class="max-w-3xl text-6xl font-bold">Turn your data to beautiful
                charts with ease</h2>
            <p class="mt-4 max-w-xl text-lg text-neutral-600">
                Easily transform your raw data into stunning charts and graphs. Whether you're a
                business analyst, researcher, or just curious about your data, our intuitive tool
                makes
                visualization a breeze.
            </p>
            <a class="mt-8 flex items-center gap-2 rounded-md border border-neutral-300 px-6 py-2 font-bold hover:bg-black hover:text-white"
                href={{ route('register') }}>
                Get Started <x-icons.arrow-forward class="w-5 fill-current" />
            </a>
        </section>
        ...
        <section class="grid grid-cols-[2fr_3fr] gap-12 px-20 py-16">
            <div>
                ...
                <p class="mt-4 w-4/5 text-lg text-neutral-600">
        ...
        <section class="gap-12 px-20 pb-20 pt-16">
            <div class="w-3/5">
                ...
                <a class="mt-8 inline-flex items-center gap-2 rounded-md border border-neutral-300 px-6 py-2 font-bold hover:bg-black hover:text-white"
                    href={{ route('register') }}>Get Started <x-icons.arrow-forward
                        class="w-5 fill-current" /></a>
            </div>
        </section>
